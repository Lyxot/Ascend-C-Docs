...
## 参数说明
<table summary="" frame="border" border="1" rules="all"><caption><b>表1 </b>参数列表</caption><thead><tr><th align="left" valign="top"><p>接口</p></th><th align="left" valign="top"><p>输入/输出</p></th><th align="left" valign="top"><p>功能</p></th></tr></thead><tbody><tr><td valign="top"><p>typeSize</p></td><td valign="top"><p>输入</p></td><td valign="top"><p>算子输入的数据类型大小，单位为字节。比如算子输入的数据类型为half，此处应传入2。</p></td></tr><tr><td valign="top"><p>maxLiveNodeCount</p></td><td valign="top"><p>输出</p></td><td valign="top"><p>最大存活节点数，表示临时空间是单次计算数据量所占空间的多少倍。</p></td></tr><tr><td valign="top"><p>extraBuffer</p></td><td valign="top"><p>输出</p></td><td valign="top"><p>使用的额外临时空间大小，单位为byte。</p></td></tr></tbody></table>
