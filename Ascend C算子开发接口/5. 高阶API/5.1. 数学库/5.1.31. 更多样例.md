...
下面的样例展示了数学库Kernel侧API和[PlatformAscendC::ReserveLocalMemory](https://www.hiascend.com/doc_center/source/zh/CANNCommunityEdition/82RC1/API/ascendcopapi/atlasascendc_api_07_00061.html)的配合使用方法，流程如下：
...
下面以[Exp](https://www.hiascend.com/doc_center/source/zh/CANNCommunityEdition/82RC1/API/ascendcopapi/atlasascendc_api_07_0588.html)接口的关键调用代码为例，辅以调用前后数据打印结果，展示模板参数isReuseSource的使用及其相关影响。
