...
<tr><th valign="top"><p>参数</p></th><th valign="top"><p>输入/输出</p></th><th valign="top"><p>说明</p></th></tr>
<tr><td valign="top"><p>attrName</p></td><td valign="top"><p>输入</p></td><td valign="top"><p>算子的属性名称</p></td></tr>
<tr><td valign="top"><p>attrValue</p></td><td valign="top"><p>输入</p></td><td valign="top"><p>算子属性值，支持int64_t、bool、std::string、float、std::vector&lt;float&gt;、std::vector&lt;int64_t&gt;、</p><p>std::vector&lt;std::string&gt;、std::vector&lt;bool&gt;、std::vector&lt;std::vector&lt;int64_t&gt;&gt;类型的指定。</p></td></tr>
</table>
