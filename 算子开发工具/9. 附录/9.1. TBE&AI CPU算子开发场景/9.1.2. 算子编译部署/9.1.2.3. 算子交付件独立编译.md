...
2. 编译算子交付件。
  ...
  <tbody><tr><td>compile</td><td>用于编译算子交付件。</td><td>是</td></tr><tr><td>-i，<br>--input</td><td>算子交付件所在路径，可配置为绝对路径或者相对路径。工具执行用户需要有此路径的可读权限。</td><td>是</td></tr><tr><td>-c，<br>--cann</td><td>CANN软件的安装目录。</td><td>否</td></tr><tr><td>-h，<br>--help</td><td>帮助提示参数。</td><td>否</td></tr></tbody>
  </table>
