...
此段代码为了将保证搬入和搬出之间的流水同步，存在LocalTensor -> LocalTensor的DataCopy指令。
...
将LocalTensor -> LocalTensor的DataCopy指令替换为TQueBind接口，避免将VECIN拷贝到VECOUT的步骤，从而避免了冗余拷贝。
...
template <typename ComputeT> class KernelExample {
 ...
 private:
     ...
     TQueBind<TPosition::VECIN, TPosition::VECOUT, BUFFER_NUM> queBind; // 使用TQueBind替换原来QueI，QueO
     ...
 };
...
![图1 aiv_vec_time优化前后对比](https://www.hiascend.com/doc_center/source/zh/CANNCommunityEdition/82RC1/opdevg/ascendcbestP/figure/zh-cn_image_0000002336158548.png)
